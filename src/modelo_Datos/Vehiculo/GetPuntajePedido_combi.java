...
public class GetPuntajePedido_combi {
	...
	public void test_pedido_5_pasajeros() {
		Pedido pedido = new Pedido(this.user_logeado,5,false,false,5,Constantes.ZONA_STANDARD);
		int puntaje = this.combi.getPuntajePedido(pedido);
	...
	public void test_pedido_5_pasajeros_con_baul() {
		Pedido pedido = new Pedido(this.user_logeado,5,false,true,5,Constantes.ZONA_STANDARD);
		int puntaje = this.combi.getPuntajePedido(pedido);
	...
	public void test_pedido_5_pasajeros_con_mascota() {
		Pedido pedido = new Pedido(this.user_logeado,5,true,false,5,Constantes.ZONA_STANDARD);
		assertNull(this.combi.getPuntajePedido(pedido));
	}

	@Test
	public void test_pedido_10_pasajeros() {
		Pedido pedido = new Pedido(this.user_logeado,10,false,false,5,Constantes.ZONA_STANDARD);
		assertNull(this.combi.getPuntajePedido(pedido));
	}
