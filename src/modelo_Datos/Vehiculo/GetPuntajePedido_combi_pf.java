...
public class GetPuntajePedido_combi_pf {
	...
	public void test_pedido_1_pasajero() {
		Pedido pedido = new Pedido(this.user_logeado,1,true,false,5,Constantes.ZONA_STANDARD);
	...
	public void test_pedido_5_pasajeros_con_baul() {
		Pedido pedido = new Pedido(this.user_logeado,5,true,true,5,Constantes.ZONA_STANDARD);
		int puntaje = this.combi.getPuntajePedido(pedido);
	...
	public void test_pedido_10_pasajeros() {
		Pedido pedido = new Pedido(this.user_logeado,10,true,false,5,Constantes.ZONA_STANDARD);
