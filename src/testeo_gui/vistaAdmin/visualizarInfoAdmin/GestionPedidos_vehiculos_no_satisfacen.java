...
public class GestionPedidos_vehiculos_no_satisfacen {
	...
	public void setUp() throws Exception {
		...
		Vehiculo combi_aux = new Combi("ccc111",5,true);
		...
		this.pedido2 = new Pedido(clientes.get("tutu"),9,false,false,5,Constantes.ZONA_SIN_ASFALTAR);
	...
	public void lista_vehiculos_pedido_ningun_vehiculo_satisface() { //no hace click en la lista de pedidos pendientes
		...
		robot.delay(5000);
		assertEquals(0,lista_vehiculos.getModel().getSize());
	}
